...
const Footer = () => {
  return (
    <footer
      className="flex flex-col md:flex-row justify-between items-center bg-amber-300 w-full"
    >
      <div className="my-5 mx-3">
        <i className="w-full">
          <img src={logo} alt="logo" className="w-[80px] rounded-xl m-auto " />
        </i>
        <p className="text-[#061c2d] text-sm my-3">
          Analytix Hive | The Pan-African Tech School
        </p>
      </div>

      <div className="text-[#061c2d] my-5 text-center">
      ...
      <div className="mx-5 w-36 my-5 text-center">
